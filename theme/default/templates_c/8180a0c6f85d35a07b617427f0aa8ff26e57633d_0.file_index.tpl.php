<?php
/* Smarty version 5.4.5, created on 2025-07-27 03:06:33
  from 'file:index.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.5',
  'unifunc' => 'content_688597b944fb58_61168783',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8180a0c6f85d35a07b617427f0aa8ff26e57633d' => 
    array (
      0 => 'index.tpl',
      1 => 1751707919,
      2 => 'file',
...
function content_688597b944fb58_61168783 (\Smarty\Template $_smarty_tpl) {
...
?>
            <div class="splide__slide">
                <div data-card-height="300" class="card mx-3 rounded-l shadow-l">
                    <div class="card-top">
                        <span class="badge bg-blue-dark text-uppercase p-2 rounded-s m-4"><?php echo $_smarty_tpl->getValue('n')['category'];?>
</span>
                    </div>
...
'>
                            <h1 class="font-18 line-height-m color-white font-500 mb-0">
                                <?php echo $_smarty_tpl->getValue('n')['title'];?>

                            </h1>
                        </a>
                    </div>
                    <div class="card-overlay bg-gradient"></div>
                    <img class="card-bg owl-lazy" loading="lazy" src="<?php echo $_smarty_tpl->getValue('n')['thumbnail'];?>
">
                </div>
            </div>
            <?php
        ...
        <div class="card card-style ms-0 me-0 mb-2 bg-theme">
            <div class="row mt-3 pt-1 mb-3">
                <div class="col-6">
                    ...
                    <h5 class="color-theme float-start font-13 font-500 line-height-s pb-3 mb-3">Pengajar<br><?php echo $_smarty_tpl->getValue('stats')['teachers'];?>
</h5>
                </div>
                <div class="col-6">
                    ...
                    <h5 class="color-theme float-start font-13 font-500 line-height-s pb-3 mb-3">Siswa<br><?php echo $_smarty_tpl->getValue('stats')['siswa'];?>
</h5>
                </div>
                <div class="col-6">
                    ...
                    <h5 class="color-theme float-start font-13 font-500 line-height-s">Prestasi<br><?php echo $_smarty_tpl->getValue('stats')['prestasi'];?>
</h5>
                </div>
                <div class="col-6">
...
" width="50" class="me-3">
			...
			<div>
				<h2 class="mb-0 pt-1 color-white"><?php echo $_smarty_tpl->getValue('settings')['sitename'];?>
</h2>
				<p class="color-grass-light font-11 mt-n1 mb-3">Tentang Sekolah</p>
			</div>
		</div>
		<p class="color-white">
			<i class="fa fa-map-marker-alt color-white"></i> <?php echo $_smarty_tpl->getValue('settings')['school_address'];?>

		</p>
    </div> 
    <div class="card-bottom m-3">
        <a href="<?php echo $_smarty_tpl->getValue('settings')['sitemaps'];?>
" class="float-end bg-highlight btn btn-xs text-uppercase font-900 rounded-xl font-11 ms-2" target="_blank"><i class="fa fa-map-marker-alt me-2"></i> Lokasi</a>
