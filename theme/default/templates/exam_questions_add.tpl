...
<div class="bg-white card-style mb-3 mx-0 border-2 border-start border-primary">
	<div class="content mb-0">
		...
		<div class="input-style input-style-always-active no-borders has-icon validate-field mb-4">
			...
			<input name="question_text" type="text" class="form-control validate-name" id="question_text" placeholder="Masukkan pertanyaan" value="">
			<label for="question_text" class="text-uppercase font-700 font-10">Pertanyaan</label>
		</div>
		<div class="input-style input-style-always-active no-borders has-icon validate-field mb-4">
			<i class="fa fa-dot-circle color-highlight"></i>
			<input name="option_a" type="text" class="form-control validate-name" id="option_a" placeholder="Masukkan jawaban opsi A" value="">
			<label for="option_a" class="text-uppercase font-700 font-10">Jawaban A</label>
		</div>
		<div class="input-style input-style-always-active no-borders has-icon validate-field mb-4">
			<i class="fa fa-dot-circle color-highlight"></i>
			<input name="option_b" type="text" class="form-control validate-name" id="option_b" placeholder="Masukkan jawaban opsi B" value="">
			<label for="option_b" class="text-uppercase font-700 font-10">Jawaban B</label>
		</div>
		<div class="input-style input-style-always-active no-borders has-icon validate-field mb-4">
			<i class="fa fa-dot-circle color-highlight"></i>
			<input name="option_c" type="text" class="form-control validate-name" id="option_c" placeholder="Masukkan jawaban opsi C" value="">
			<label for="option_c" class="text-uppercase font-700 font-10">Jawaban C</label>
		</div>
		<div class="input-style input-style-always-active no-borders has-icon validate-field mb-4">
			<i class="fa fa-dot-circle color-highlight"></i>
			<input name="option_d" type="text" class="form-control validate-name" id="option_d" placeholder="Masukkan jawaban opsi D" value="">
		...
		<div class="input-style input-style-always-active no-borders has-icon validate-field mb-4">
			<i class="fa fa-dot-circle color-highlight"></i>
			<input name="points" type="number" step="1" min="1" class="form-control validate-name" id="points" placeholder="Masukkan skor/poin jika benar" value="1">
