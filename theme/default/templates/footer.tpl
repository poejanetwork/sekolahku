...
<div id="menu-language" class="menu menu-box-bottom menu-box-detached rounded-m" data-menu-height="240" data-menu-effect="menu-over">
    <div class="me-3 ms-3 mt-3">
        ...
        <div class="list-group list-custom-small">
            <a href='{"?p=lang_id"|surl}'><img class="me-3 mt-n1" width="20" src="{$settings.siteurl}/{$theme}/assets/images/flags/Indonesia.png"><span>Indonesia</span><i class="fa fa-angle-right"></i></a>
            <a href='{"?p=lang_en"|surl}'><img class="me-3 mt-n1" width="20" src="{$settings.siteurl}/{$theme}/assets/images/flags/United-States.png"><span>English</span><i class="fa fa-angle-right"></i></a>
        </div>
        <div class="clear"></div>
    </div>
</div>

<script type="text/javascript" src="{$settings.siteurl}/{$theme}/assets/scripts/bootstrap.minv35.js"></script>
<script type="text/javascript" src="{$settings.siteurl}/{$theme}/assets/scripts/customv35.js?v=1"></script>
</body>
</html>
