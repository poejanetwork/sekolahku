...
{if $newscat}
	...
	<div class="card card-style" data-card-height="230">
		<div class="card-top">
			<span class="badge bg-green-dark px-2 py-2 color-white m-3 float-end"><i class="fa fa-star pe-2 color-yellow-light"></i>{$nc.category}</span>
		</div>
		...
		<a href='{"?p=news&{$n.id}"|surl}'>
			<div class="d-flex mb-3">
				<div class="align-self-center">
					...
					<span class="color-theme font-11 ps-2 opacity-50">{$n.created_at|date_format:"%B %e, %Y"}</span>
				</div>
