...
$composerAutoload = dirname(dirname(dirname(__DIR__))) . 'libs/autoload.php';
if (!file_exists($composerAutoload)) {
    //If the project is used as its own project, it would use rest-api-sdk-php composer autoloader.
    $composerAutoload = dirname(__DIR__) . '/libs/vendor/autoload.php';
    if (!file_exists($composerAutoload)) {
...
function getApiContextUsingConfigIni()
{
    ...
    $apiContext = ApiContext::create('main', 'doge', 'v1');
    return $apiContext;
}
/**
 ...
 * @return ApiContext
 */
function getApiContextUsingConfigArray($token, $chain = 'main', $coin = 'doge', $version = 'v1')
{
